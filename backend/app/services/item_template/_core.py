...
from app.models.item_template import DAMAGE_TYPES, EQUIPMENT_SLOTS, ITEM_TYPES, RARITIES, ItemTemplate
from app.models.user import User
from app.schemas.item_template import ItemTemplateCreate, ItemTemplateUpdate
from app.services.campaign.service import require_campaign_access, user_can_access
